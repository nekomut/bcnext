...
export const e1055Data: StageData = {
  eventId: 1055,
  eventName: "開眼のさむらい襲来！",
  typeId: 1,
  typeName: "イベントステージ",
  ...
  stages: [
    {
      ...
      treasures: [
        {
          treasureId: "10021",
          treasureName: "ネコパティシエへの進化権(ネコざむらいの第3形態)",
          probability: "5",
          amount: "1",
          times: "-1",
          limitText: "-1"
