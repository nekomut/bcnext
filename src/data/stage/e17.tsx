...
export const e17Data: StageData = {
  eventId: 17,
  eventName: "脱獄トンネル",
  typeId: 0,
  typeName: "レジェンドストーリー",
  ...
  crownData: {
    crownCount: 4,
    magnifications: [100, 150, 170, 150],
    baseDifficulty: 1
  },
  stages: [
    {
