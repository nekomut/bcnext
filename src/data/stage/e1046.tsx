...
export const e1046Data: StageData = {
  eventId: 1046,
  eventName: "開眼のカンフー襲来！",
  typeId: 1,
  typeName: "イベントステージ",
  ...
  stages: [
    {
      ...
      treasures: [
        {
          treasureId: "10011",
          treasureName: "ネコダンサーへの進化権(カンフーにゃんこの第3形態)",
          probability: "5",
          amount: "1",
          times: "-1",
          limitText: "-1"
