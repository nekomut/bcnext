...
export const e36007Data: StageData = {
  eventId: 36007,
  eventName: "異次元コロシアム",
  typeId: 36,
  typeName: "異次元コロシアム",
  ...
  specialRule: {
    name: "超特売セール　EX",
    explanation: "【超特売セール　EX】 レア度：EXの味方キャラクターの生産コストと 生産スピードが70％OFFになります",
    ruleTypes: {
      "5": {
        "Parameters": [100, 30, 100, 100, 100, 100]
      },
      "6": {
        "Parameters": [100, 30, 100, 100, 100, 100]
      }
