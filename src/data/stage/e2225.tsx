...
export const e2225Data: StageData = {
  eventId: 2225,
  eventName: "ケミカルプラントゾーン",
  typeId: 2,
  typeName: "コラボステージ",
  prefix: "C",
  mapId: 225,
