...
export const e1296Data: StageData = {
  eventId: 1296,
  eventName: "絶・奈落門",
  typeId: 1,
  typeName: "イベントステージ",
  ...
  stages: [
    ...
    },
    {
      ...
      treasures: [
        {
          treasureId: "10522",
          treasureName: "ネコナーガへの進化権(ネコメデューサの第3形態)",
          probability: "100",
          amount: "1",
          times: "-1",
          limitText: "-1"
