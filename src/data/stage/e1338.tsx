...
export const e1338Data: StageData = {
  eventId: 1338,
  eventName: "絶・綺羅星ペロ降臨",
  typeId: 1,
  typeName: "イベントステージ",
  ...
  stages: [
    ...
    },
    {
      ...
      treasures: [
        {
          treasureId: "10540",
          treasureName: "ニャッハーへの進化権(ラガーにゃんの第3形態)",
          probability: "100",
          amount: "1",
          times: "-1",
          limitText: "-1"
