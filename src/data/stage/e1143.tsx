...
export const e1143Data: StageData = {
  eventId: 1143,
  ...
  stages: [
    {
      ...
      treasures: [
        {
          treasureId: "10184",
          treasureName: "にゃんこカートPへの進化権(にゃんこカートRの第3形態)",
          probability: "5",
          amount: "1",
          times: "-1",
          limitText: "-1"
