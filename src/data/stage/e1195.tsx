...
export const e1195Data: StageData = {
  eventId: 1195,
  eventName: "絶・緊急爆風警報",
  typeId: 1,
  typeName: "イベントステージ",
  ...
  stages: [
    ...
    },
    {
      ...
      treasures: [
        {
          treasureId: "10268",
          treasureName: "ネコあらしへの進化権(ネコタイフーンの第3形態)",
          probability: "100",
          amount: "1",
          times: "-1",
          limitText: "-1"
