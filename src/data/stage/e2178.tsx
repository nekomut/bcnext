...
export const e2178Data: StageData = {
  eventId: 2178,
  eventName: "くるみ割りの魔女",
  typeId: 2,
  typeName: "コラボステージ",
  ...
  stages: [
    {
      ...
      treasures: [
        {
          treasureId: "10301",
          treasureName: "ちび悪魔ほむらへの進化権(ちびほむらの第3形態)",
          probability: "5",
          amount: "1",
          times: "-2",
          limitText: "-2"
