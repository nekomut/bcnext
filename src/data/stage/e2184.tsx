...
export const e2184Data: StageData = {
  eventId: 2184,
  eventName: "高雄ライトレール",
  typeId: 2,
  typeName: "コラボステージ",
  ...
  stages: [
    {
      ...
      enemies: [
        ...
        },
        {
          enemyId: "597",
          enemyName: "ダミー",
          icon: "",
          traits: ["無"],
          baseStats: {
            hp: 135000,
            ap: 7500,
