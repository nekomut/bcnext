...
export const e1047Data: StageData = {
  eventId: 1047,
  eventName: "開眼のMr.襲来！",
  typeId: 1,
  typeName: "イベントステージ",
  ...
  stages: [
    {
      ...
      treasures: [
        {
          treasureId: "10012",
          treasureName: "Hyper Mr.への進化権(Mr.の第3形態)",
          probability: "5",
          amount: "1",
          times: "-1",
          limitText: "-1"
