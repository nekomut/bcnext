...
export const e2099Data: StageData = {
  eventId: 2099,
  eventName: "天上の世界(旧)",
  typeId: 2,
  typeName: "コラボステージ",
  ...
  stages: [
    {
      ...
      enemies: [
        ...
        },
        {
          enemyId: "461",
          enemyName: "カノとソウマ",
          icon: "",
          traits: ["無"],
          baseStats: {
            hp: 80000,
            ap: 800,
