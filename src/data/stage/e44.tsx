...
export const e044Data: StageData = {
  eventId: 44,
  eventName: "ブリザード自動車道",
  typeId: 0,
  typeName: "レジェンドストーリー",
