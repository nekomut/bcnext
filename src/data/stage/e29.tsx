...
export const e29Data: StageData = {
  eventId: 29,
  eventName: "暗黒コスモポリス",
  typeId: 0,
  typeName: "レジェンドストーリー",
