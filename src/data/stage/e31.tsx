...
export const e31Data: StageData = {
  eventId: 31,
  eventName: "岩海苔半島",
  typeId: 0,
  typeName: "レジェンドストーリー",
  ...
  crownData: {
    crownCount: 4,
    magnifications: [100, 120, 140, 100],
    baseDifficulty: 1
  },
  stages: [
    {
