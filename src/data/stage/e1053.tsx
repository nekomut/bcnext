...
export const e1053Data: StageData = {
  eventId: 1053,
  eventName: "開眼の忍者襲来！",
  typeId: 1,
  typeName: "イベントステージ",
  ...
  stages: [
    {
      ...
      treasures: [
        {
          treasureId: "10019",
          treasureName: "ムササビネコ忍者への進化権(ネコ忍者の第3形態)",
          probability: "5",
          amount: "1",
          times: "-1",
          limitText: "-1"
