...
export const e36004Data: StageData = {
  eventId: 36004,
  eventName: "異次元コロシアム",
  typeId: 36,
  typeName: "異次元コロシアム",
  ...
  specialRule: {
    name: "特売セール　激レア",
    explanation: "【特売セール　激レア】  レア度：激レアの味方キャラクターの生産コストが 半分になり生産スピードが倍になります",
    ruleTypes: {
      "5": {
        "Parameters": [100, 100, 100, 50, 100, 100]
      },
      "6": {
        "Parameters": [100, 100, 100, 50, 100, 100]
      }
