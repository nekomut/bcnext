...
export const e2226Data: StageData = {
  eventId: 2226,
  eventName: "スカイサンクチュアリ",
  typeId: 2,
  typeName: "コラボステージ",
  prefix: "C",
  mapId: 226,
